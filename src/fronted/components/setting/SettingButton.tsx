...
const SettingButton = ({
    ...
    return (
        <button
            className={cn(
                'text-white py-2 px-4 rounded h-fit w-fit text-sm border-2 border-black',
                kind === 'primary' &&
                    'bg-black hover:bg-black/90 hover:border-black/90 disabled:bg-black/80 disabled:border-black/80',
                kind === 'secondary' &&
                    'text-black bg-white  hover:border-black/90 disabled:border-black/80'
            )}
